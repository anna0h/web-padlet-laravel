...
class PadletController extends Controller
{
    ...
    {
        $padlets = Padlet::where('id', $id)->with(['user', 'entries', 'userrights'])->get();
        return response()->json($padlets, 200);
    }
    ...
    /* create new Book */
    /* annahme: User müssen eigenloggt sein, um Padlets zu erstellen
    /* userrights können erst später vergeben werden, Entries auch erst, wenn Padlet erstellt */
